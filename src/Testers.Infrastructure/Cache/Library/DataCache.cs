...
// CA1001 suppressed: the class implements the Dispose() pattern manually but doesn't
// declare IDisposable on the type. Worth fixing upstream; for now we silence here.
#nullable disable
